...
// ── Exported helpers for axios interceptor (non-reactive) ───────────
/** Read the current token value — used by axios request interceptor */
export function getAuthToken(): string | null {
  return token.value;
}

/** Clear session — used by axios 401 response interceptor */
